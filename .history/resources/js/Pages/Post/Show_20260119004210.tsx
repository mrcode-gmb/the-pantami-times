                  ...
                  <div className="flex items-center space-x-3 relative">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48">
                        ...
                        <DropdownMenuItem
  onClick={() => {
    // URL of the image to share (must be public)
    const imageUrl = encodeURIComponent(post.image);

    // Instagram Story URL
    const instagramStoryUrl = `https://www.instagram.com/stories/create/?media=${imageUrl}`;

    // Open in new tab / mobile Instagram app
