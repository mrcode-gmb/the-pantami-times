    ...
    <section className="container py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6">
          {featuredPost && (
            <div className="relative h-[400px] lg:h-[500px] rounded overflow-hidden group cursor-pointer bg-muted">
              <MediaDisplay
              ...
              <Link href={route('posts.show.full', featuredPost.slug)} className="absolute bottom-0 left-0 right-0 p-6">
