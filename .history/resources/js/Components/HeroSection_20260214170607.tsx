        ...
        <div className="order-3 lg:order-3 lg:col-span-3 gap-3">
          ...
          <div className="space-y-4">
            {latestPosts.map((post) => (
              <Link href={route('posts.show.full', post.href={route("posts.show.full", post.public_id)})} key={post.id} className="border-b border-border pb-4 last:border-b-0 cursor-pointer group">
