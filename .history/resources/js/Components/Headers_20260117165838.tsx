                ...
                return (
                  <div key={item.label} className="relative border-r ">
                    <button
                      ...
                      className={`px-4 py-3 text-sm font-bold text-black hover:bg-[#d99200] transition-colors whitespace-nowrap uppercase tracking-wide flex items-center gap-1 ${isActive ? 'bg-[#d99200]' : ''
                        }`}
                    >
                      {item.label}
                      {hasSubcategories && (
