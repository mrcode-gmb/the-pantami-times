                ...
                return (
                  <div key={item.label} className="relative">
                    <button
                      ...
                      className={`px-4 py-3 text-sm news-title-sm  border-r text-black hover:bg-[#d99200] hover:text-black transition-colors whitespace-nowrap uppercase tracking-wide flex items-center ${isActive ? 'bg-white' : ''
                        }`}
                    >
                      {item.label}
                      {hasSubcategories && (
