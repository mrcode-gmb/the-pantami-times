                ...
                return (
                  <div key={item.label} className="relative border-r ">
                    <button
                      ...
                      className={`px-4 py-4 text-sm news-title-sm  text-black hover:bg-[#d99200] transition-colors whitespace-nowrap uppercase tracking-wide flex items-center gap-1 ${isActive ? 'bg-white' : ''
                        }`}
                    >
                      {item.label}
                      {hasSubcategories && (
