...
<head>
    ...
    <meta name="description"
        content="The Pantami Times - Your trusted source for breaking news, analysis, and in-depth reporting. Stay informed with the latest news from around the world.">
    <meta name="keywords"
        content="news, breaking news, world news, politics, business, technology, sports, entertainment, The Pantami Times">
    <meta name="author" content="The Pantami Times">
    ...
    {{-- RSS Feed --}}
    <link rel="alternate" type="application/rss+xml" title="{{ config('app.name') }} RSS Feed"
        href="{{ url('/feed') }}">
